...
void changePasswordMenu()
{
	...
	while (strcmp(userInput, "exit") != 0)
	{
		...
		cout << "Whose password do you feel like changing?\n\n";
		struct user* userSwap;
...
void addStudioMenu()
{
	...
	cout << "We are going to add a studio!\n";
...
// Danger
{
	...
	cout << "Feel like going back and check out the ID of the studio that you are going to delete?(y/n)\n";
	//printf("Your input: ");
	cout << "Your input: ";
	gets_s(userInput, 1000);
	deleteSpaceInTheEnd(userInput, 1000);
	...
	// If the user knows the ID
	{
		...
		cout << "Please input the ID of the studio that you are going to delete: ";
		...
		else
		{
			...
			if (strcmp(inputSpace, "y") == 0)
			{
				...
				cout << "Forcely returning tickets...";
...
void ReportABrokenSeatMenu()
{
	...
	cout << "We are going to report a broken seat!\n\n\n";
	//printf("Do you wanna go back and check out the ID of the studio?(y/n)\n");
	cout << "Do you wanna go back and check out the ID of the studio?(y/n)\n";
	//printf("Your input: ");
	cout << "Your input: ";
	char userInput[1000];
	memset(userInput, '\0', sizeof(userInput));
		...
		// If the user knows the ID
	{
		...
		cout << "Please input the ID of the studio which has a broken seat to report: ";
		long long int inputID;
		scanf_s("%lld", &inputID);
		...
		if (targetStudioWhichOne != -1)
		{
			...
			cout << "Which seat do you want to report?\n";
